...
# Create the ServerFlags section of the XF86Config
#
# CVS ID:
# --------
# Status: Up-to-date
...
#---[ CreateServerFlagsSection ]----#
sub CreateServerFlagsSection {
#----------------------------------------------
...
#
	...
	# create header line...
	@result = ();
	push(@result,"Section \"ServerFlags\"\n");

	# create body...
	foreach $i (sort keys %{$var{ServerFlags}{0}}) {
		$setting = $var{ServerFlags}{0}{$i};
		if ($setting ne "") {
