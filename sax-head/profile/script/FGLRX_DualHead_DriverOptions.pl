...
if (ProfileIsNoteBookHardware()) {
	...
	print FD "$dx->Raw->20->Option=\"Mode2\" \"1024x768\"\n";
	print FD "$dx->Raw->21->Option=\"HSync2\" \"31-48\"\n";
	print FD "$dx->Raw->22->Option=\"VRefresh2\" \"50-60\"\n";
    print FD "$dx->Raw->23->Option=\"DesktopSetup\" \"Clone\"\n";
	print FD "$dx->Raw->24->Option=\"ForceMonitors\" \"auto,crt1\"\n";
