...
#
# neededforbuild  dbus-1 doxygen flex ghostscript-fonts-std graphviz hal java2-devel-packages python python-devel qt3-devel-packages swig sysfsutils udev update-desktop-files x-devel-packages yacc readline-devel hal-devel dbus-1-devel pkgconfig
